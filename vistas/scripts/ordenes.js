...
// presenta en el card de boton servicio , la orden de  servicios unificado y valor
...
function cargarDetalleOrden(idOrden) {
  $.getJSON("../ajax/agenda.php?op=obtenerDetalleOrden&id_orden=" + idOrden, function(response) {
    ...
    detalle.forEach(item => {
      if (!equiposMap[item.id_equipo]) {
        equiposMap[item.id_equipo] = {
          id: item.id_equipo,
      ...
      equiposMap[item.id_equipo].servicios.push({
